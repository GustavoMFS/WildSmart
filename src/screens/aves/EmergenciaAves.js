...
const EmergenciaAves = ({ navigation }) => {
    ...
    const calcular = () => {
        const res = [];
        for (let i = 0; i < medEmergenciaAves.length; i++) {
            const nomeMedicamento = medEmergenciaAves[i].nome;
            const especies = medEmergenciaAves[i].especies;
            const doses = medEmergenciaAves[i].doses;
            const concentracao = medEmergenciaAves[i].concentracao;
