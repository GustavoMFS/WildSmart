...
const EmergenciaMamiferos = ({ navigation }) => {
    ...
    const calcular = () => {
        const res = [];
        for (let i = 0; i < medEmergenciaMamiferos.length; i++) {
            const nomeMedicamento = medEmergenciaMamiferos[i].nome;
            const especies = medEmergenciaMamiferos[i].especies;
            const doses = medEmergenciaMamiferos[i].doses;
            const concentracao = medEmergenciaMamiferos[i].concentracao;
...
export default EmergenciaMamiferos;